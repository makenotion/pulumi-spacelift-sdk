...
export class ScheduledDeleteStack extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScheduledDeleteStackState, opts?: pulumi.CustomResourceOptions): ScheduledDeleteStack {
        return new ScheduledDeleteStack(name, <any>state, { ...opts, id: id });
    }
     ...
     */
    public static isInstance(obj: any): obj is ScheduledDeleteStack {
    ...
    constructor(name: string, argsOrState?: ScheduledDeleteStackArgs | ScheduledDeleteStackState, opts?: pulumi.CustomResourceOptions) {
