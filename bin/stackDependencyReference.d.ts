...
export declare class StackDependencyReference extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StackDependencyReferenceState, opts?: pulumi.CustomResourceOptions): StackDependencyReference;
    /**
     * Returns true if the given object is an instance of StackDependencyReference.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StackDependencyReference;
    /**
     * Name of the input of the stack dependency reference
     */
    readonly inputName: pulumi.Output<string>;
    /**
    ...
    readonly stackDependencyReferenceId: pulumi.Output<string>;
    /**
     * Whether the dependents should be triggered even if the value of the reference did not change.
     */
    readonly triggerAlways: pulumi.Output<boolean | undefined>;
    /**
