...
class GcpServiceAccount extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new GcpServiceAccount(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
GcpServiceAccount.__pulumiType = 'spacelift-terraform-provider:index/gcpServiceAccount:GcpServiceAccount';
