...
class ContextAttachment extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ContextAttachment(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
ContextAttachment.__pulumiType = 'spacelift-terraform-provider:index/contextAttachment:ContextAttachment';
