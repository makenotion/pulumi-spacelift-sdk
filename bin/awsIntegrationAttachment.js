...
class AwsIntegrationAttachment extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new AwsIntegrationAttachment(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
AwsIntegrationAttachment.__pulumiType = 'spacelift-terraform-provider:index/awsIntegrationAttachment:AwsIntegrationAttachment';
