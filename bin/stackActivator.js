...
exports.StackActivator = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class StackActivator extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new StackActivator(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.StackActivator = StackActivator;
/** @internal */
StackActivator.__pulumiType = 'spacelift:index/stackActivator:StackActivator';
//# sourceMappingURL=stackActivator.js.map