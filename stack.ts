...
export class Stack extends pulumi.CustomResource {
     ...
     * to `true`.
     */
    public readonly enableSensitiveOutputsUpload!: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    public readonly pulumiInfo!: pulumi.Output<outputs.StackPulumiInfo | undefined>;
    /**
